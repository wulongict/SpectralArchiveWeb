...
function Peptide(seq, staticModifications, varModifications, ntermModification, ctermModification, maxNeutralLossCount) {
    ...
    function _initNeutralLosses()
    {
        ...
        // added by L WU
        // todo: use oxidationLoss
        var oxidationLoss = NeutralLoss.OxidationLoss();
        ...
        // added by L. WU
        potentialLosses_lorikeet[oxidationLoss.label()]=oxidationLoss;
        ...
        for(var i = 0; i < sequence.length; i += 1)
        {
            ...
            if (aa == 'M')
            {
                console.log('find M in peptide', sequence);
                potentialLossesAtIndex[i].push(oxidationLoss);
            }
        }
    }
...
// added by L. Wu Apr. 16
// todo: NeutralLoss.OxidationLoss
// 
NeutralLoss.OxidationLoss = function _getOxidationLoss()
{
    return new NeutralLoss(Ion.OxidationLossMass_mono, Ion.OxidationLossMass_avg, "CH3SOH", "ox");
}
